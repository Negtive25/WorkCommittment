...
public class VideoCommentController {
     ...
     * id: 评论id
     */
    @PostMapping("/api/videoComment/deleteVideoComment/{id}")
     ...
     * content: 评论内容
     */
    @PostMapping("/api/videoComment/updateVideoComment")
     ...
     * videoId: 视频id
     */
    @PostMapping("/api/videoComment/selectVideoComment/{videoId}")
     ...
     * parentId: 父评论id
     */
    @PostMapping("/api/videoComment/selectReplyComment")
