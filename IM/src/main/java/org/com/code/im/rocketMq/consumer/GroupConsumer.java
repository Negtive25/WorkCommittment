    ...
    public void onMessage(String sessionInfo) {
        ...
        if (requestType.equals("createGroup")) {
            try {
                ...
                ResponseHandler response = new ResponseHandler(ResponseHandler.ERROR,"创建群聊",null);
                ChannelCrud.sendMessage(ownerId,response.toJSONString());
            ...
            try {
                ...
                ResponseHandler response = new ResponseHandler(ResponseHandler.ERROR,"邀请用户入群聊",null);
                ChannelCrud.sendMessage(ownerId,response.toJSONString());
