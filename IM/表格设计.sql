...
CREATE TABLE videos (
    ...
    `status` ENUM('waitToReview', 'approved', 'rejected') DEFAULT 'waitToReview' COMMENT '视频审核状态',
...
CREATE TABLE posts (
    ...
    INDEX idx_community_post_userId (userId),           -- Index for finding posts by user
    INDEX idx_community_post_type (TYPE),                -- Index for filtering by type
